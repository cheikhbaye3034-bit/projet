...
export const INITIAL_MEMBRES = [
  { id: 'm1', nom: 'MBACKE', prenom: 'Serigne Cheikh', telephone: '+221 77 123 45 67', adresse: 'Touba Mosquée, Quartier Darou Minam', profession: 'Salarié', date_adhesion: '2021-02-10', statut: 'Actif', kourel_id: 'k1', zone_id: 'z1', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Août 2026' },
  { id: 'm2', nom: 'NDIAYE', prenom: 'Cheikh Ahmadou', telephone: '+221 78 234 56 78', adresse: 'Dakar, Mermoz Pyrotechnie', profession: 'Étudiant', date_adhesion: '2020-05-12', statut: 'Actif', kourel_id: 'k1', zone_id: 'z2', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Août 2026' },
  { id: 'm3', nom: 'DIOP', prenom: 'Moustapha', telephone: '+221 70 345 67 89', adresse: 'Thiès, Quartier Dixième', profession: 'Salarié', date_adhesion: '2022-01-20', statut: 'Actif', kourel_id: 'k1', zone_id: 'z3', cotisation_statut: 'En retard', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Juin 2026' },
  { id: 'm4', nom: 'FALL', prenom: 'Ibrahima', telephone: '+221 76 456 78 90', adresse: 'Saint-Louis, Balacos', profession: 'Élève', date_adhesion: '2023-04-15', statut: 'Actif', kourel_id: 'k2', zone_id: 'z4', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Août 2026' },
  { id: 'm5', nom: 'SOW', prenom: 'Mouhamadou Bamba', telephone: '+221 77 567 89 01', adresse: 'Touba, Guédé Bousso', profession: 'Salarié', date_adhesion: '2019-11-03', statut: 'Actif', kourel_id: 'k2', zone_id: 'z1', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Juillet 2026' },
  { id: 'm6', nom: 'GUEYE', prenom: 'Khadim', telephone: '+221 78 678 90 12', adresse: 'Dakar, Sacré-Cœur 3', profession: 'Étudiant', date_adhesion: '2021-08-25', statut: 'Actif', kourel_id: 'k2', zone_id: 'z2', cotisation_statut: 'En retard', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Mai 2026' },
  { id: 'm7', nom: 'SECK', prenom: 'Abdoulaye', telephone: '+221 70 789 01 23', adresse: 'Kaolack, Medina Baye', profession: 'Sans emploi', date_adhesion: '2022-09-14', statut: 'Inactif', kourel_id: 'k3', zone_id: 'z5', cotisation_statut: 'En retard', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Avril 2026' },
  { id: 'm8', nom: 'SY', prenom: 'Serigne Fallou', telephone: '+221 76 890 12 34', adresse: 'Touba, Dianatoul Mahwa', profession: 'Autre', date_adhesion: '2020-03-30', statut: 'Actif', kourel_id: 'k3', zone_id: 'z1', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Août 2026' },
  { id: 'm9', nom: 'LO', prenom: 'Ousmane', telephone: '+221 77 901 23 45', adresse: 'Dakar, Yoff APECSY', profession: 'Salarié', date_adhesion: '2021-12-01', statut: 'Actif', kourel_id: 'k3', zone_id: 'z2', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Août 2026' },
  { id: 'm10', nom: 'CISSE', prenom: 'Mame Diarra', telephone: '+221 78 012 34 56', adresse: 'Rufisque, HLM 2', profession: 'Étudiant', date_adhesion: '2023-01-10', statut: 'Actif', kourel_id: 'k4', zone_id: 'z2', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Août 2026' },
  { id: 'm11', nom: 'SARR', prenom: 'Fatou Bintou', telephone: '+221 70 123 45 67', adresse: 'Dakar, Liberté 6 Extension', profession: 'Salarié', date_adhesion: '2022-05-18', statut: 'Actif', kourel_id: 'k4', zone_id: 'z2', cotisation_statut: 'À jour', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Août 2026' },
  { id: 'm12', nom: 'KANE', prenom: 'Babacar', telephone: '+221 76 234 56 78', adresse: 'Diourbel, Thierno Kandji', profession: 'Élève', date_adhesion: '2023-09-02', statut: 'Suspendu', kourel_id: 'k1', zone_id: 'z3', cotisation_statut: 'En retard', cotisation_montant: '5 000 FCFA', dernier_paiement: 'Février 2026' },
];

export const INITIAL_KHASSIDAS = [
  { id: 'kh1', titre: 'Mawahibou Nafi (Les Dons du Profit)', auteur: 'Cheikh Ahmadou Bamba', texte: 'Khassida louange et prières sur le Prophète (PSL)...', niveau: 'Avancé', versets_count: 144, duree_estimee: '25 min' },
  { id: 'kh2', titre: 'Jalibatul Maratib (L’Attirante des Degrés)', auteur: 'Cheikh Ahmadou Bamba', texte: 'Demandes d’élévation spirituelle et de bénédictions...', niveau: 'Intermédiaire', versets_count: 98, duree_estimee: '18 min' },
  { id: 'kh3', titre: 'Assirou (Le Secret)', auteur: 'Cheikh Ahmadou Bamba', texte: 'Protections et bienfaits divins...', niveau: 'Débutant', versets_count: 54, duree_estimee: '12 min' },
  { id: 'kh4', titre: 'Matlabul Fawzayni (La Quête du Bonheur dans les deux Mondes)', auteur: 'Cheikh Ahmadou Bamba', texte: 'Invocation pour le salut d’ici-bas et de l’au-delà...', niveau: 'Avancé', versets_count: 180, duree_estimee: '30 min' },
  { id: 'kh5', titre: 'Silkul Jawahir (Le Collier de Perles)', auteur: 'Cheikh Ahmadou Bamba', texte: 'Poème de louanges sacrées...', niveau: 'Intermédiaire', versets_count: 110, duree_estimee: '20 min' },
];

export const INITIAL_SONS_AUDIO = [
  {
    id: 'son1',
    titre: 'Mawahibou Nafi — Version Officielle Kourel 1',
    khassida_id: 'kh1',
    recitateur: 'Kourel Miftahoul Mouna',
    duree: '24:15',
    qualite: 'HQ 320 kbps',
    audio_url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',
    date_enregistrement: '2026-06-15',
    taille: '18.4 Mo'
  },
  {
    id: 'son2',
    titre: 'Jalibatul Maratib — Rythme Apprentissage',
    khassida_id: 'kh2',
    recitateur: 'Serigne Modou Kara',
    duree: '17:40',
    qualite: 'HQ 256 kbps',
    audio_url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',
    date_enregistrement: '2026-07-02',
    taille: '12.8 Mo'
  },
  {
    id: 'son3',
    titre: 'Assirou — Récitation Lente pour Débutants',
    khassida_id: 'kh3',
    recitateur: 'Cheikh Ahmadou Ndiaye',
    duree: '12:10',
    qualite: 'HQ 192 kbps',
    audio_url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3',
    date_enregistrement: '2026-05-20',
    taille: '8.9 Mo'
  },
  {
    id: 'son4',
    titre: 'Matlabul Fawzayni — Récitation Complète',
    khassida_id: 'kh4',
    recitateur: 'Kourel Nurou Darayni',
    duree: '29:50',
    qualite: 'HQ 320 kbps',
    audio_url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3',
    date_enregistrement: '2026-07-28',
    taille: '22.1 Mo'
  }
];
