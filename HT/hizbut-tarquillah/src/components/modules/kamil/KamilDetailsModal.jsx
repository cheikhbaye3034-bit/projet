...
import { X, Users, CheckCircle2, BookOpen, Search, Clock, Calendar, ShieldCheck, ChevronRight, Phone } from 'lucide-react';
import { useApp } from '../../../context/AppContext';

export const KamilDetailsModal = ({ isOpen, onClose, initialTab = 'membres' }) => {
  const { kamilCycle, membres, kourels } = useApp();
  const [activeTab, setActiveTab] = useState(initialTab); // 'membres' | 'termines' | 'tous'
  ...
  // Filtered members list for Tab 1
  ...
  // Filtered completed list for Tab 2
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-ht-mint text-ht-emerald text-[11px] font-extrabold">
                ...
                <span>Détails & Suivi Avancé du Kamil #{kamilCycle.numero_cycle}</span>
              </div>
              <h2 className="font-display font-extrabold text-2xl text-ht-ink mt-0.5">
                Détail des Membres & Parties du Coran
              </h2>
            </div>
          </div>
        ...
        <div className="p-5 border-b border-ht-line bg-white flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span>Membres Impliqués ({involvedMembers.length})</span>
            </button>
          ...
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              type="text"
              placeholder="Rechercher membre ou Juki..."
              value={searchQuery}
